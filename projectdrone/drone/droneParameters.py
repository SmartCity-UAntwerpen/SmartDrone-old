...
class DroneParameters:
    ...
    def __init__(self):
        ...
        # path contains waypoints in the right order with the first waypoint the current position
        # and the last waypoint the final destination. will be filled in when a job is received,
        # is cleared when a job is finished
        self.path = []
        self.currentwaypointID = 0
        self.onJob = False
        # 0 = Good communication with camera
