...
def plan_path(droneparameters, destinationWP):
    above_takeoffWP = waypoint.Waypoint(droneparameters.X, droneparameters.Y, 125) # height of 20cm, change desired flight height here
    above_destinationWP = waypoint.Waypoint(destinationWP.X, destinationWP.Y, 125) # height of 20cm, change desired flight height here
